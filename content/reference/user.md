...
| `birthday`           | string                     | Birthday of the user, with format YYYY-MM-DD. This field is present only if the authenticated user has permission to read it.                                                                                                                 |
| `country`            | string                     | Two-letter ISO code of the country where the user lives. This field is present only if the authenticated user has permission to read it.                                                                                                      |
...
| `email`              | string                     | Email of the user. This field is present only if the authenticated user has permission to read it.                                                                                                                                            |
...
| `nationality`        | string                     | Two-letter ISO code of the nationality of the user. This field is present only if the authenticated user has permission to read it.                                                                                                           |
| `personal_id_number` | string                     | This field is present only if the authenticated user has permission to read it.                                                                                                                                                               |
